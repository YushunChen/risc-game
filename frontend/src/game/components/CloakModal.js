    ...
    return (
        <>
            <Modal show={showModal}>
                ...
                <Modal.Body>
                    <p>If you cloak a territory, it will be hidden from view for 3 turns. Cloaking only hides from adjacent enemy territories, but not from an enemy spy in the territory.</p>
